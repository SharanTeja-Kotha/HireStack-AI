...
**HireStack** is an intelligent recruitment platform that uses machine learning to evaluate CVs and match candidates with relevant job opportunities. It combines a production-ready backend API with a modern web interface to streamline the hiring process.
...
**Visit the application here:** [https://hirestack-frontend.onrender.com](https://hirestack-frontend.onrender.com)

**Backend API:** [https://hirestack-backend.onrender.com](https://hirestack-backend.onrender.com)
...
```env
# Database
DATABASE_URL=postgresql://user:password@db:5432/hirestack
