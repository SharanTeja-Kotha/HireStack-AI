...
SEED_RECRUITER_POSTS = [
    {
        ...
        "company_name": "HireStack",
        "category": "Data Science",
        "location": "Remote - US/Europe",
        "salary_min": 90000, "salary_max": 140000,
        "required_skills": "Python, TensorFlow, PyTorch, MLOps, Docker",
        "description": "We are seeking a senior ML engineer to join our AI team. You will design, develop, and deploy machine learning models in production.",
    },
    {
        "title": "Full-Stack Python / Angular Developer",
        "company_name": "HireStack",
        "category": "Web Development",
        "location": "New York, NY",
        "salary_min": 75000, "salary_max": 115000,
        "required_skills": "Python, FastAPI, Angular, PostgreSQL, Docker",
        "description": "Full-stack developer role to contribute to our web platforms. Stack: Python/FastAPI backend, Angular frontend.",
    },
    {
        ...
        "description": "Analyze business data and produce decision-making dashboards for leadership.",
    },
    {
        ...
        "salary_min": 85000, "salary_max": 130000,
        "required_skills": "Docker, Kubernetes, CI/CD, AWS, Terraform",
        "description": "Automate deployment pipelines and manage cloud infrastructure for our applications.",
    },
    {
        ...
        "salary_min": 95000, "salary_max": 145000,
        "required_skills": "Agile, Scrum, Jira, Leadership, Communication",
        "description": "Lead digital projects, coordinate technical teams, and ensure on-time delivery.",
    },
    {
        ...
        "description": "Data science internship. You will work on automated CV classification using NLP models.",
    },
]


SEED_USERS = [
    {"full_name": "Admin", "email": "admin@hirestack.ai", "password": "Admin1234!", "role": "admin"},
    {"full_name": "Demo Recruiter", "email": "recruiter@hirestack.ai", "password": "HireStack2026!", "role": "recruiter", "company": "HireStack"},
    {"full_name": "Demo Candidate", "email": "candidate@hirestack.ai", "password": "HireStack2026!", "role": "candidate"},
]
...
def seed_recruiter_posts(db) -> int:
    ...
    recruiter = db.execute(
        select(User).where(User.email == "recruiter@hirestack.ai")
    ).scalars().first()
    if not recruiter:
        return 0
