    ...
    <div class="showcase">
      ...
      <div class="sc-hero">
        <div style="position:relative;z-index:2;">
          ...
          <h1 class="anim-hero anim-delay-1">
            Our Project <span class="gradient-text">HireStack</span>
          </h1>
          <p class="anim-hero anim-delay-2">
            Intelligent resume screening, job recommendation, and prediction platform powered by state-of-the-art Machine Learning models.
          </p>
          <div class="sc-hero-stats anim-hero anim-delay-3">
            <div class="sc-stat">
              <span class="sc-stat-val">5</span>
              <span class="sc-stat-lbl">ML Models</span>
            </div>
            <div class="sc-stat">
              <span class="sc-stat-val">Jobs</span>
              <span class="sc-stat-lbl">Recommendation</span>
            </div>
            <div class="sc-stat">
              <span class="sc-stat-val">Predictions</span>
              <span class="sc-stat-lbl">Hiring & Salary</span>
            </div>
            <div class="sc-stat">
              <span class="sc-stat-val">Developed by</span>
              <span class="sc-stat-lbl">K. Sharan Teja</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="sc-section aos">
          ...
          <div class="pipeline-wrap">
            <div class="pipe-step">
              ...
              <h4>Collection</h4>
              <p>PDF upload / forms + online job scraping</p>
            </div>
            ...
            <div class="pipe-step">
              ...
              <h4>Preprocessing</h4>
              <p>Text extraction, NLP cleaning, feature engineering</p>
            </div>
            <div class="pipe-arrow"><i class="fas fa-arrow-right"></i></div>
            <div class="pipe-step">
              ...
              <h4>ML Models</h4>
              <p>Classification, regression, clustering, NLP</p>
            </div>
            <div class="pipe-arrow"><i class="fas fa-arrow-right"></i></div>
            <div class="pipe-step">
              ...
              <h4>Prediction</h4>
              <p>Score, salary, cluster, role, recommendations</p>
            </div>
            <div class="pipe-arrow"><i class="fas fa-arrow-right"></i></div>
            <div class="pipe-step">
              ...
              <h4>Results</h4>
              <p>Interactive dashboard, job recommendations</p>
            </div>
          </div>
        </div>
        ...
        <div class="sc-section aos">
          ...
          <div class="model-grid">
            <div class="model-card-sc" style="--model-color:linear-gradient(90deg,#60a5fa,#2563eb);">
              ...
              <h4>Hiring Classifier</h4>
              <p>Predicts the probability of a candidate being hired based on resume features.</p>
            ...
            <div class="model-card-sc" style="--model-color:linear-gradient(90deg,#38bdf8,#0284c7);">
              ...
              <span class="model-type-badge type-reg">Regression</span>
              <h4>Salary Predictor</h4>
              <p>Estimates expected salary based on experience, education, and skills.</p>
              <div class="model-metrics">
            ...
            <div class="model-card-sc" style="--model-color:linear-gradient(90deg,#f472b6,#db2777);">
              ...
              <h4>Candidate Segmentation</h4>
              <p>Groups candidates into homogenous clusters (Junior, Mid, Senior, Expert) via KMeans.</p>
              <div class="model-metrics">
            ...
            <div class="model-card-sc" style="--model-color:linear-gradient(90deg,#fbbf24,#ea580c);">
              ...
              <h4>Role Classifier (Resume)</h4>
              <p>Analyzes resume text (PDF) and predicts candidate job role across 24 categories.</p>
              <div class="model-metrics">
                <span class="model-metric">TF-IDF + SVM</span>
                <span class="model-metric">24 categories</span>
            ...
            <div class="model-card-sc" style="--model-color:linear-gradient(90deg,#f472b6,#ec4899);">
              ...
              <span class="model-type-badge type-rec">Recommendation</span>
              <h4>Job Recommender</h4>
              <p>Matches resumes with job openings using cosine similarity on TF-IDF vectors.</p>
              <div class="model-metrics">
        ...
        <div class="sc-section aos">
          ...
          <div class="dataset-grid">
            <div class="ds-card">
              ...
              <p>Resumes categorized into 24 professional roles for NLP classifier training.</p>
            </div>
            <div class="ds-card">
              <span class="ds-count">~1,500</span>
              <h4>AI Resume Screening</h4>
              <p>Structured dataset with numerical features for classification and regression models.</p>
            </div>
            <div class="ds-card">
              <span class="ds-count">20k+</span>
              <h4>Data Jobs (Kaggle)</h4>
              <p>Data & Tech job postings with location, salary, skills, and company.</p>
            </div>
            <div class="ds-card">
              <span class="ds-count">Live</span>
              <h4>Online Scraping</h4>
              <p>Automated web scraping of job boards to enrich postings in real-time.</p>
            </div>
          </div>
        </div>
            ...
            <div class="adg">
              ...
              <div class="adg-tier">
                ...
                <div class="adg-node">
                  ...
                  <h5>PostgreSQL 16</h5><small>Database</small>
              ...
              <!-- Data pipeline -->
              <div class="adg-divider">Data Pipeline</div>
              <div class="adg-tier">
                <div class="adg-node">
                ...
                <div class="adg-node">
                  ...
                  <h5>CSV / DB</h5><small>Import &amp; Indexing</small>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="sc-section aos">
          ...
          <div class="tech-cards">
            ...
            <div class="tech-card-sc">
              ...
              <h4>Angular 17</h4>
              <p>SPA with Signals & lazy loading</p>
            </div>
            <div class="tech-card-sc">
            ...
            <div class="tech-card-sc">
              ...
              <p>Multi-container orchestration</p>
            </div>
            <div class="tech-card-sc">
        ...
        <div class="sc-cta aos">
          <a routerLink="/analyze" class="btn btn-primary btn-lg" style="font-size:1.05rem;padding:16px 40px;">
            <i class="fas fa-rocket"></i> Try Resume Analysis Now
          </a>
        </div>
