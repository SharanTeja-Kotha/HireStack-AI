# HireStack — Architecture Overview

## System at a Glance

HireStack is a full-stack AI-powered CV screening and job-matching platform.
...
| `JWT_SECRET`           | `hirestack-change-me` | JWT signing key                   |
