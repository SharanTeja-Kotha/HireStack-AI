# HireStack — AI-Powered Intelligent Recruitment Platform
...
HireStack is a production-ready AI recruitment platform that analyses CVs through a **3-phase ML pipeline**, recommends matching jobs from 20 000+ real job postings, and provides a full recruiter/candidate/admin web interface with an integrated AI chatbot.
...
| URL | Description |
|---|---|
| https://hirestack-frontend.onrender.com | Angular SPA (live demo) |
| https://hirestack-backend.onrender.com | FastAPI backend |
...
| Email | Role | Password |
|---|---|---|
| `admin@hirestack.ai` | admin | `Admin1234!` |
| `recruiter@hirestack.ai` | recruiter | `Esprit2026!` |
| `candidate@hirestack.ai` | candidate | `Esprit2026!` |
...
|---|---|---|
| `DATABASE_URL` | `postgresql://cverify:cverify_secret@db:5432/hirestack` | PostgreSQL connection |
| `JWT_SECRET` | `hirestack-prod-change-this-secret-key` | JWT signing secret (**change in production**) |
