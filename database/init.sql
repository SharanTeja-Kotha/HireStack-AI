-- ============================================================
-- HireStack — PostgreSQL Initial Schema
...
-- ── Seed HireStack accounts (password: Esprit2026!) ─────────────
INSERT INTO users (email, hashed_password, full_name, role, company, is_active)
VALUES ('imed.attia@hirestack.ai',
...
INSERT INTO users (email, hashed_password, full_name, role, company, is_active)
VALUES ('khalil.chiha@hirestack.ai',
        '$2b$12$DJDIo8tTyqRVa3WaSBw7Fe/5gZyLPrZYttZq.O6/HqNBPdvp5LX0i',
        'Khalil Chiha',
        'recruiter',
        'HireStack',
...
INSERT INTO users (email, hashed_password, full_name, role, company, is_active)
VALUES ('zaineb.khlifi@hirestack.ai',
        '$2b$12$DJDIo8tTyqRVa3WaSBw7Fe/5gZyLPrZYttZq.O6/HqNBPdvp5LX0i',
        'Zaineb Khlifi',
        'candidate',
        NULL,
...
INSERT INTO users (email, hashed_password, full_name, role, company, is_active)
VALUES ('yessine.mnejja@hirestack.ai',
        '$2b$12$DJDIo8tTyqRVa3WaSBw7Fe/5gZyLPrZYttZq.O6/HqNBPdvp5LX0i',
        'Yessine Mnejja',
        'candidate',
        NULL,
